# target path in your repo: ignition-scripts/hospital_patients.py
#
# HOW TO USE THIS FILE — Ignition does not load loose .py files from disk.
# Script Library code lives inside the Gateway's project storage and is edited
# through the Designer. To get this into your project:
#   1. Open the Designer, open your project (e.g. "LovieHospital")
#   2. In the Project Browser, right-click "Script Library" -> New Package -> name it "hospital"
#   3. Right-click the "hospital" package -> New Script -> name it "patients"
#   4. Paste everything below the "=== PASTE BELOW ===" line into that script's editor
#   5. Save (Ctrl+S) — Ignition validates Jython syntax on save
#
# Once Phase 0 has your Postgres container running and you've added a Database
# Connection named "LovieHospital" in the Gateway config (Config -> Databases ->
# Connections), these functions are callable anywhere in Ignition as
# hospital.patients.check_in(...), hospital.patients.log_vitals(...), etc.
#
# This is Jython 2.7, not modern Python 3 — no f-strings, and the standard
# library is mostly pure-Python modules only (uuid works fine; things needing
# C extensions, like numpy, do not).
#
# === PASTE BELOW ===
